...
![Cove Video Editor v2.0.0](docs/screenshot.png)
...
# Output in release/:
#   Cove-Video-Editor-2.0.0-x86_64.AppImage
#   cove-video-editor_2.0.0_amd64.deb
```

`SKIP_DEB=1 VERSION=2.0.0 bash scripts/build-release.sh` builds just the
AppImage.
...
# Output in release\:
#   cove-video-editor-2.0.0-Setup.exe
#   cove-video-editor-2.0.0-Portable.exe
```
